...
void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_hollerith_1literal_1constant(JNIEnv *env, jobject this, jobject jarg_0)
{
	Token_t *carg_0 = NULL;
	...
	c_action_hollerith_literal_constant(carg_0);
...
void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_parenthesized_1expr(JNIEnv *env, jobject this)
{
...
void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_do_1term_1action_1stmt(JNIEnv *env, jobject this, jobject jarg_0, jobject jarg_1, jobject jarg_2, jobject jarg_3, jobject jarg_4, jboolean jarg_5)
{
	Token_t *carg_0 = NULL;
	Token_t *carg_1 = NULL;
	Token_t *carg_2 = NULL;
	...
	c_action_do_term_action_stmt(carg_0, carg_1, carg_2, carg_3, carg_4, carg_5);
...
void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_goto_1stmt(JNIEnv *env, jobject this, jobject jarg_0, jobject jarg_1, jobject jarg_2, jobject jarg_3, jobject jarg_4)
{
	Token_t *carg_0 = NULL;
	Token_t *carg_1 = NULL;
	Token_t *carg_2 = NULL;
	...
	c_action_goto_stmt(carg_0, carg_1, carg_2, carg_3, carg_4);
...
void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_start_1of_1file(JNIEnv *env, jobject this, jstring jarg_0, jstring jarg_1)
{
	const char *carg_0 = NULL;
	const char *carg_1 = NULL;
	...
	if(jarg_1 != NULL)
	{
		...
		carg_1 = (*env)->GetStringUTFChars(env, jarg_1, NULL);
	}

	c_action_start_of_file(carg_0, carg_1);

	(*env)->ReleaseStringUTFChars(env, jarg_0, carg_0);
	(*env)->ReleaseStringUTFChars(env, jarg_1, carg_1);
}

void Java_fortran_ofp_parser_c_jni_FortranParserActionJNI_end_1of_1file(JNIEnv *env, jobject this, jstring jarg_0, jstring jarg_1)
{
	const char *carg_0 = NULL;
	const char *carg_1 = NULL;
	...
	c_action_end_of_file(carg_0, carg_1);
