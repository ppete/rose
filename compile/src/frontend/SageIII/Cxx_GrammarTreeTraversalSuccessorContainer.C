...
SgNode*
SgBaseClass::get_traversalSuccessorByIndex(size_t) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgBaseClass" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
size_t
SgBaseClass::get_childIndex(SgNode *) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgBaseClass" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
vector<SgNode*>
SgExpBaseClass::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
...
vector<string>
SgExpBaseClass::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_base_class");
traversalSuccessorContainer.push_back("p_base_class_exp");
return traversalSuccessorContainer;
...
size_t
SgExpBaseClass::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgExpBaseClass::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_base_class;
case 1: return p_base_class_exp;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgExpBaseClass::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgJavaParameterizedType::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(7);
/* typeString = SgReferenceType* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaParameterizedType::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_ref_to");
traversalSuccessorContainer.push_back("p_ptr_to");
traversalSuccessorContainer.push_back("p_modifiers");
...
size_t
SgJavaParameterizedType::get_numberOfTraversalSuccessors() {
return 7;
}
SgNode *
SgJavaParameterizedType::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_ref_to;
case 1: return p_ptr_to;
case 2: return p_modifiers;
...
size_t
SgJavaParameterizedType::get_childIndex(SgNode *child) {
if (child == p_ref_to) return 0;
else if (child == p_ptr_to) return 1;
else if (child == p_modifiers) return 2;
else if (child == p_typedefs) return 3;
...
vector<SgNode*>
SgHeaderFileBody::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
vector<string>
SgHeaderFileBody::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
size_t
SgHeaderFileBody::get_numberOfTraversalSuccessors() {
return 0;
}
SgNode *
SgHeaderFileBody::get_traversalSuccessorByIndex(size_t idx) {
cout << "error: get_traversalSuccessorByIndex called on node of type " << "SgHeaderFileBody" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return NULL;
}
size_t
SgHeaderFileBody::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgTemplateFunctionDefinition::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgBasicBlock* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgTemplateFunctionDefinition::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_body");
return traversalSuccessorContainer;
}
size_t
SgTemplateFunctionDefinition::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgTemplateFunctionDefinition::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_body;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgTemplateFunctionDefinition::get_childIndex(SgNode *child) {
if (child == p_body) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
vector<SgNode*>
SgTemplateClassDefinition::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_members.size() + 0);
/* typeString = SgDeclarationStatementPtrList */
/* isSTLContainer   (typeString) = true */
...
vector<string>
SgTemplateClassDefinition::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgDeclarationStatementPtrList::iterator  iter;
...
size_t
SgTemplateClassDefinition::get_numberOfTraversalSuccessors() {
return p_members.size() + 0;
}
SgNode *
SgTemplateClassDefinition::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_members.size());
return p_members[idx];
}
size_t
SgTemplateClassDefinition::get_childIndex(SgNode *child) {
SgDeclarationStatementPtrList::iterator itr = find(p_members.begin(), p_members.end(), child);
if (itr != p_members.end()) return itr - p_members.begin();
else return (size_t) -1;
}
...
vector<SgNode*>
SgJavaForEachStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(3);
/* typeString = SgVariableDeclaration* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaForEachStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_element");
traversalSuccessorContainer.push_back("p_collection");
traversalSuccessorContainer.push_back("p_loop_body");
...
size_t
SgJavaForEachStatement::get_numberOfTraversalSuccessors() {
return 3;
}
SgNode *
SgJavaForEachStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_element;
case 1: return p_collection;
case 2: return p_loop_body;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgJavaForEachStatement::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgJavaLabelStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgStatement* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaLabelStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_statement");
return traversalSuccessorContainer;
}
size_t
SgJavaLabelStatement::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgJavaLabelStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
...
size_t
SgJavaLabelStatement::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgTemplateClassDeclaration::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgTemplateClassDefinition* */
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
...
vector<string>
SgTemplateClassDeclaration::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_definition");
return traversalSuccessorContainer;
}
size_t
SgTemplateClassDeclaration::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgTemplateClassDeclaration::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
...
size_t
SgTemplateClassDeclaration::get_childIndex(SgNode *child) {
if (child == p_definition) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgTemplateFunctionDeclaration::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgTemplateFunctionDefinition* */
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
traversalSuccessorContainer.push_back(p_definition);
return traversalSuccessorContainer;
...
vector<string>
SgTemplateFunctionDeclaration::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_definition");
return traversalSuccessorContainer;
}
size_t
SgTemplateFunctionDeclaration::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgTemplateFunctionDeclaration::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_definition;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgTemplateFunctionDeclaration::get_childIndex(SgNode *child) {
if (child == p_definition) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgTemplateMemberFunctionDeclaration::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgTemplateFunctionDefinition* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgTemplateMemberFunctionDeclaration::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_definition");
return traversalSuccessorContainer;
}
size_t
SgTemplateMemberFunctionDeclaration::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgTemplateMemberFunctionDeclaration::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_definition;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgTemplateMemberFunctionDeclaration::get_childIndex(SgNode *child) {
if (child == p_definition) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
case 1: return p_decoratorList;
case 2: return p_definition;
case 3: return p_CtorInitializerList;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
switch (idx) {
case 0: return p_headerFileBody;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
vector<SgNode*>
SgStmtDeclarationStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgStatement* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgStmtDeclarationStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_statement");
return traversalSuccessorContainer;
}
size_t
SgStmtDeclarationStatement::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgStmtDeclarationStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_statement;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgStmtDeclarationStatement::get_childIndex(SgNode *child) {
if (child == p_statement) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
vector<SgNode*>
SgWithStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgWithStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_expression");
traversalSuccessorContainer.push_back("p_body");
return traversalSuccessorContainer;
...
size_t
SgWithStatement::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgWithStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_expression;
case 1: return p_body;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgWithStatement::get_childIndex(SgNode *child) {
if (child == p_expression) return 0;
else if (child == p_body) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgPythonPrintStmt::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgPythonPrintStmt::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_destination");
traversalSuccessorContainer.push_back("p_values");
return traversalSuccessorContainer;
...
size_t
SgPythonPrintStmt::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgPythonPrintStmt::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_destination;
case 1: return p_values;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgPythonPrintStmt::get_childIndex(SgNode *child) {
if (child == p_destination) return 0;
else if (child == p_values) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgPassStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
vector<string>
SgPassStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
size_t
SgPassStatement::get_numberOfTraversalSuccessors() {
return 0;
}
SgNode *
SgPassStatement::get_traversalSuccessorByIndex(size_t idx) {
cout << "error: get_traversalSuccessorByIndex called on node of type " << "SgPassStatement" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return NULL;
}
size_t
SgPassStatement::get_childIndex(SgNode *child) {
cout << "error: get_childIndex called on node of type " << "SgPassStatement" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return 0; 
}
vector<SgNode*>
SgAssertStmt::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgAssertStmt::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_test");
traversalSuccessorContainer.push_back("p_exception_argument");
return traversalSuccessorContainer;
...
size_t
SgAssertStmt::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgAssertStmt::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_test;
case 1: return p_exception_argument;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgAssertStmt::get_childIndex(SgNode *child) {
if (child == p_test) return 0;
else if (child == p_exception_argument) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgExecStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(3);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgExecStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_executable");
traversalSuccessorContainer.push_back("p_globals");
traversalSuccessorContainer.push_back("p_locals");
...
size_t
SgExecStatement::get_numberOfTraversalSuccessors() {
return 3;
}
SgNode *
SgExecStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_executable;
case 1: return p_globals;
case 2: return p_locals;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgExecStatement::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgPythonGlobalStmt::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
...
vector<string>
SgPythonGlobalStmt::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgInitializedNamePtrList::iterator  iter;
...
size_t
SgPythonGlobalStmt::get_numberOfTraversalSuccessors() {
return p_names.size() + 0;
}
SgNode *
SgPythonGlobalStmt::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_names.size());
return p_names[idx];
}
size_t
SgPythonGlobalStmt::get_childIndex(SgNode *child) {
SgInitializedNamePtrList::iterator itr = find(p_names.begin(), p_names.end(), child);
if (itr != p_names.end()) return itr - p_names.begin();
else return (size_t) -1;
}
vector<SgNode*>
SgJavaThrowStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
vector<string>
SgJavaThrowStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
size_t
SgJavaThrowStatement::get_numberOfTraversalSuccessors() {
return 0;
}
SgNode *
SgJavaThrowStatement::get_traversalSuccessorByIndex(size_t idx) {
cout << "error: get_traversalSuccessorByIndex called on node of type " << "SgJavaThrowStatement" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return NULL;
}
size_t
SgJavaThrowStatement::get_childIndex(SgNode *child) {
cout << "error: get_childIndex called on node of type " << "SgJavaThrowStatement" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return 0; 
}
vector<SgNode*>
SgJavaSynchronizedStatement::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaSynchronizedStatement::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_expression");
traversalSuccessorContainer.push_back("p_body");
return traversalSuccessorContainer;
...
size_t
SgJavaSynchronizedStatement::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgJavaSynchronizedStatement::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_expression;
case 1: return p_body;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgJavaSynchronizedStatement::get_childIndex(SgNode *child) {
if (child == p_expression) return 0;
else if (child == p_body) return 1;
else return (size_t) -1;
}
...
vector<SgNode*>
SgJavaUnsignedRshiftOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaUnsignedRshiftOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgJavaUnsignedRshiftOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgJavaUnsignedRshiftOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgJavaUnsignedRshiftOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
...
SgNode*
SgCompoundAssignOp::get_traversalSuccessorByIndex(size_t) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgCompoundAssignOp" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
size_t
SgCompoundAssignOp::get_childIndex(SgNode *) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgCompoundAssignOp" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
vector<SgNode*>
SgJavaUnsignedRshiftAssignOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaUnsignedRshiftAssignOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgJavaUnsignedRshiftAssignOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgJavaUnsignedRshiftAssignOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgJavaUnsignedRshiftAssignOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgIntegerDivideAssignOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgIntegerDivideAssignOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgIntegerDivideAssignOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgIntegerDivideAssignOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgIntegerDivideAssignOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgExponentiationAssignOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgExponentiationAssignOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgExponentiationAssignOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgExponentiationAssignOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgExponentiationAssignOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgMembershipOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgMembershipOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgMembershipOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgMembershipOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgMembershipOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgNonMembershipOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgNonMembershipOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgNonMembershipOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgNonMembershipOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgNonMembershipOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgIsOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgIsOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgIsOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgIsOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgIsOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgIsNotOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgIsNotOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_lhs_operand_i");
traversalSuccessorContainer.push_back("p_rhs_operand_i");
return traversalSuccessorContainer;
...
size_t
SgIsNotOp::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgIsNotOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_lhs_operand_i;
case 1: return p_rhs_operand_i;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgIsNotOp::get_childIndex(SgNode *child) {
if (child == p_lhs_operand_i) return 0;
else if (child == p_rhs_operand_i) return 1;
else return (size_t) -1;
}
...
vector<SgNode*>
SgListExp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_expressions.size() + 0);
/* typeString = SgExpressionPtrList */
/* isSTLContainer   (typeString) = true */
...
vector<string>
SgListExp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgExpressionPtrList::iterator  iter;
...
size_t
SgListExp::get_numberOfTraversalSuccessors() {
return p_expressions.size() + 0;
}
SgNode *
SgListExp::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_expressions.size());
return p_expressions[idx];
}
size_t
SgListExp::get_childIndex(SgNode *child) {
SgExpressionPtrList::iterator itr = find(p_expressions.begin(), p_expressions.end(), child);
if (itr != p_expressions.end()) return itr - p_expressions.begin();
else return (size_t) -1;
}
vector<SgNode*>
SgTupleExp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_expressions.size() + 0);
/* typeString = SgExpressionPtrList */
/* isSTLContainer   (typeString) = true */
...
vector<string>
SgTupleExp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgExpressionPtrList::iterator  iter;
...
size_t
SgTupleExp::get_numberOfTraversalSuccessors() {
return p_expressions.size() + 0;
}
SgNode *
SgTupleExp::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_expressions.size());
return p_expressions[idx];
}
size_t
SgTupleExp::get_childIndex(SgNode *child) {
SgExpressionPtrList::iterator itr = find(p_expressions.begin(), p_expressions.end(), child);
if (itr != p_expressions.end()) return itr - p_expressions.begin();
else return (size_t) -1;
}
...
switch (idx) {
case 0: return p_real_value;
case 1: return p_imaginary_value;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
SgNode *
SgCallExpression::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_function;
...
size_t
SgCallExpression::get_childIndex(SgNode *child) {
if (child == p_function) return 0;
...
vector<SgNode*>
SgJavaInstanceOfOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgJavaInstanceOfOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_operand_expr");
return traversalSuccessorContainer;
}
size_t
SgJavaInstanceOfOp::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgJavaInstanceOfOp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_operand_expr;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgJavaInstanceOfOp::get_childIndex(SgNode *child) {
if (child == p_operand_expr) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgSuperExp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
vector<string>
SgSuperExp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
size_t
SgSuperExp::get_numberOfTraversalSuccessors() {
return 0;
}
SgNode *
SgSuperExp::get_traversalSuccessorByIndex(size_t idx) {
cout << "error: get_traversalSuccessorByIndex called on node of type " << "SgSuperExp" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return NULL;
}
size_t
SgSuperExp::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgCompoundInitializer::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgExprListExp* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgCompoundInitializer::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_initializers");
return traversalSuccessorContainer;
}
size_t
SgCompoundInitializer::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgCompoundInitializer::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_initializers;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgCompoundInitializer::get_childIndex(SgNode *child) {
if (child == p_initializers) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
vector<SgNode*>
SgLambdaRefExp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgFunctionDeclaration* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgLambdaRefExp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_functionDeclaration");
return traversalSuccessorContainer;
}
size_t
SgLambdaRefExp::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgLambdaRefExp::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_functionDeclaration;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgLambdaRefExp::get_childIndex(SgNode *child) {
if (child == p_functionDeclaration) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgDictionaryExp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_key_datum_pairs.size() + 0);
/* typeString = SgKeyDatumPairPtrList */
/* isSTLContainer   (typeString) = true */
/* isSTLContainerPtr(typeString) = false */
   {
     SgKeyDatumPairPtrList::iterator iter;
...
vector<string>
SgDictionaryExp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgKeyDatumPairPtrList::iterator  iter;
...
size_t
SgDictionaryExp::get_numberOfTraversalSuccessors() {
return p_key_datum_pairs.size() + 0;
}
SgNode *
SgDictionaryExp::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_key_datum_pairs.size());
return p_key_datum_pairs[idx];
}
size_t
SgDictionaryExp::get_childIndex(SgNode *child) {
SgKeyDatumPairPtrList::iterator itr = find(p_key_datum_pairs.begin(), p_key_datum_pairs.end(), child);
if (itr != p_key_datum_pairs.end()) return itr - p_key_datum_pairs.begin();
else return (size_t) -1;
}
vector<SgNode*>
SgKeyDatumPair::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgKeyDatumPair::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_key");
traversalSuccessorContainer.push_back("p_datum");
return traversalSuccessorContainer;
...
size_t
SgKeyDatumPair::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgKeyDatumPair::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_key;
case 1: return p_datum;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgKeyDatumPair::get_childIndex(SgNode *child) {
if (child == p_key) return 0;
else if (child == p_datum) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgComprehension::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(3);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgComprehension::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_target");
traversalSuccessorContainer.push_back("p_iter");
traversalSuccessorContainer.push_back("p_filters");
...
size_t
SgComprehension::get_numberOfTraversalSuccessors() {
return 3;
}
SgNode *
SgComprehension::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_target;
case 1: return p_iter;
case 2: return p_filters;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgComprehension::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgListComprehension::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgListComprehension::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_element");
traversalSuccessorContainer.push_back("p_generators");
return traversalSuccessorContainer;
...
size_t
SgListComprehension::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgListComprehension::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_element;
case 1: return p_generators;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
size_t
SgListComprehension::get_childIndex(SgNode *child) {
if (child == p_element) return 0;
else if (child == p_generators) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgSetComprehension::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgSetComprehension::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_element");
traversalSuccessorContainer.push_back("p_generators");
return traversalSuccessorContainer;
...
size_t
SgSetComprehension::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgSetComprehension::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_element;
case 1: return p_generators;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgSetComprehension::get_childIndex(SgNode *child) {
if (child == p_element) return 0;
else if (child == p_generators) return 1;
else return (size_t) -1;
}
vector<SgNode*>
SgDictionaryComprehension::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(2);
/* typeString = SgKeyDatumPair* */
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
traversalSuccessorContainer.push_back(p_element);
/* typeString = SgExprListExp* */
...
vector<string>
SgDictionaryComprehension::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_element");
traversalSuccessorContainer.push_back("p_generators");
return traversalSuccessorContainer;
...
size_t
SgDictionaryComprehension::get_numberOfTraversalSuccessors() {
return 2;
}
SgNode *
SgDictionaryComprehension::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_element;
case 1: return p_generators;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
...
size_t
SgDictionaryComprehension::get_childIndex(SgNode *child) {
if (child == p_element) return 0;
else if (child == p_generators) return 1;
else return (size_t) -1;
}
...
SgNode*
SgNaryOp::get_traversalSuccessorByIndex(size_t) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgNaryOp" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
size_t
SgNaryOp::get_childIndex(SgNode *) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgNaryOp" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
vector<SgNode*>
SgNaryBooleanOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_operands.size() + 0);
/* typeString = SgExpressionPtrList */
/* isSTLContainer   (typeString) = true */
...
vector<string>
SgNaryBooleanOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgExpressionPtrList::iterator  iter;
...
size_t
SgNaryBooleanOp::get_numberOfTraversalSuccessors() {
return p_operands.size() + 0;
}
SgNode *
SgNaryBooleanOp::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_operands.size());
return p_operands[idx];
}
size_t
SgNaryBooleanOp::get_childIndex(SgNode *child) {
SgExpressionPtrList::iterator itr = find(p_operands.begin(), p_operands.end(), child);
if (itr != p_operands.end()) return itr - p_operands.begin();
else return (size_t) -1;
}
vector<SgNode*>
SgNaryComparisonOp::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_operands.size() + 0);
/* typeString = SgExpressionPtrList */
/* isSTLContainer   (typeString) = true */
...
vector<string>
SgNaryComparisonOp::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgExpressionPtrList::iterator  iter;
...
size_t
SgNaryComparisonOp::get_numberOfTraversalSuccessors() {
return p_operands.size() + 0;
}
SgNode *
SgNaryComparisonOp::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_operands.size());
return p_operands[idx];
}
size_t
SgNaryComparisonOp::get_childIndex(SgNode *child) {
SgExpressionPtrList::iterator itr = find(p_operands.begin(), p_operands.end(), child);
if (itr != p_operands.end()) return itr - p_operands.begin();
else return (size_t) -1;
}
vector<SgNode*>
SgStringConversion::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgStringConversion::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_expression");
return traversalSuccessorContainer;
}
size_t
SgStringConversion::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgStringConversion::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_expression;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgStringConversion::get_childIndex(SgNode *child) {
if (child == p_expression) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgYieldExpression::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgExpression* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgYieldExpression::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_value");
return traversalSuccessorContainer;
}
size_t
SgYieldExpression::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgYieldExpression::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_value;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgYieldExpression::get_childIndex(SgNode *child) {
if (child == p_value) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
vector<SgNode*>
SgJavaLabelSymbol::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgJavaLabelStatement* */
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
traversalSuccessorContainer.push_back(p_declaration);
return traversalSuccessorContainer;
...
vector<string>
SgJavaLabelSymbol::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_declaration");
return traversalSuccessorContainer;
}
size_t
SgJavaLabelSymbol::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgJavaLabelSymbol::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_declaration;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgJavaLabelSymbol::get_childIndex(SgNode *child) {
if (child == p_declaration) return 0;
else return (size_t) -1;
}
vector<SgNode*>
...
vector<SgNode*>
SgAsmFunction::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
...
vector<string>
SgAsmFunction::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgAsmStatementPtrList::iterator  iter;
...
size_t
SgAsmFunction::get_numberOfTraversalSuccessors() {
return p_statementList.size() + 0;
}
SgNode *
SgAsmFunction::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_statementList.size());
return p_statementList[idx];
}
size_t
SgAsmFunction::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgAsmStaticData::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
vector<string>
SgAsmStaticData::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
return traversalSuccessorContainer;
}
size_t
SgAsmStaticData::get_numberOfTraversalSuccessors() {
return 0;
}
SgNode *
SgAsmStaticData::get_traversalSuccessorByIndex(size_t idx) {
cout << "error: get_traversalSuccessorByIndex called on node of type " << "SgAsmStaticData" << " that has no successors!" << endl;
ROSE_ASSERT(false);
return NULL;
}
size_t
SgAsmStaticData::get_childIndex(SgNode *child) {
...
vector<SgNode*>
SgAsmIntegerValueExpression::get_traversalSuccessorContainer() {
vector<SgNode*> traversalSuccessorContainer;
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgAsmIntegerValueExpression" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
return traversalSuccessorContainer;
 }
...
vector<string>
SgAsmIntegerValueExpression::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgAsmIntegerValueExpression" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
...
size_t
SgAsmIntegerValueExpression::get_numberOfTraversalSuccessors() {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgAsmIntegerValueExpression" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
SgNode*
SgAsmIntegerValueExpression::get_traversalSuccessorByIndex(size_t) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgAsmIntegerValueExpression" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
size_t
SgAsmIntegerValueExpression::get_childIndex(SgNode *) {
   cerr << "Internal error(!): called tree traversal mechanism for illegal object: " << endl
<< "static: SgAsmIntegerValueExpression" << endl << "dynamic:  " << this->sage_class_name() << endl;
cerr << "Aborting ..." << endl;
ROSE_ASSERT(false);
...
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
traversalSuccessorContainer.push_back(p_file_name);
...
switch (idx) {
case 0: return p_file_name;
case 1: return p_entries;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
traversalSuccessorContainer.push_back(p_dll_name);
/* typeString = SgAsmPEImportItemList* */
/* isSTLContainer   (typeString) = false */
/* isSTLContainerPtr(typeString) = false */
...
switch (idx) {
case 0: return p_dll_name;
case 1: return p_imports;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
return NULL;
}
...
vector<SgNode*>
SgAsmPEImportItem::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(1);
/* typeString = SgAsmGenericString* */
/* isSTLContainer   (typeString) = false */
...
vector<string>
SgAsmPEImportItem::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
traversalSuccessorContainer.push_back("p_name");
return traversalSuccessorContainer;
}
size_t
SgAsmPEImportItem::get_numberOfTraversalSuccessors() {
return 1;
}
SgNode *
SgAsmPEImportItem::get_traversalSuccessorByIndex(size_t idx) {
switch (idx) {
case 0: return p_name;
default: cout << "invalid index " << idx << " in get_traversalSuccessorByIndex()" << endl;
ROSE_ASSERT(false);
...
size_t
SgAsmPEImportItem::get_childIndex(SgNode *child) {
if (child == p_name) return 0;
else return (size_t) -1;
}
vector<SgNode*>
SgAsmPEImportItemList::get_traversalSuccessorContainer() {
  vector<SgNode*> traversalSuccessorContainer;
  traversalSuccessorContainer.reserve(p_vector.size() + 0);
/* typeString = SgAsmPEImportItemPtrList */
/* isSTLContainer   (typeString) = true */
/* isSTLContainerPtr(typeString) = false */
   {
     SgAsmPEImportItemPtrList::iterator iter;
     for (iter = p_vector.begin(); iter != p_vector.end(); iter++)
          traversalSuccessorContainer.push_back(*iter);
        }
return traversalSuccessorContainer;
...
vector<string>
SgAsmPEImportItemList::get_traversalSuccessorNamesContainer() {
vector<string> traversalSuccessorContainer;
int i = 0;
   {
     SgAsmPEImportItemPtrList::iterator  iter;
...
size_t
SgAsmPEImportItemList::get_numberOfTraversalSuccessors() {
return p_vector.size() + 0;
}
SgNode *
SgAsmPEImportItemList::get_traversalSuccessorByIndex(size_t idx) {
ROSE_ASSERT(idx < p_vector.size());
return p_vector[idx];
}
size_t
SgAsmPEImportItemList::get_childIndex(SgNode *child) {
SgAsmPEImportItemPtrList::iterator itr = find(p_vector.begin(), p_vector.end(), child);
if (itr != p_vector.end()) return itr - p_vector.begin();
else return (size_t) -1;
}
vector<SgNode*>
