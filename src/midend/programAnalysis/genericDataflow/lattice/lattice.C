...
VariablesProductLattice::VariablesProductLattice(
    ...
    const Function& func, const DataflowNode& n, const NodeState& state, PartPtr p) : func(func), Lattice(p), ProductLattice(p)
{
...
// copy constructor
VariablesProductLattice::VariablesProductLattice(const VariablesProductLattice& that) : func(that.func), Lattice(that.part), ProductLattice(that.part)
{
