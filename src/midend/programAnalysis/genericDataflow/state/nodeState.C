...
void NodeState::setLatticeAbove(const Analysis* analysis, PartEdgePtr departEdge, LatticePtr lattice)
{
  ...
  dfInfoAbove[Analysis*)analysis][departEdge] = lattice;
...
{
  // was: setLattice_ex(dfInfoAbove, analysis, departEdge, lattices);
  dfInfoBelow[Analysis*)analysis][departEdge] = lattice;
...
// (read-only access)
const std::map<PartEdgePtr, LatticePtr >& 
NodeState::getLatticeAboveAll(Analysis* analysis) const
{ 
...
LatticePtr NodeState::getLatticeAbove(Analysis* analysis, int latticeName) const
{
...
LatticePtr NodeState::getLatticeBelow(Analysis* analysis, int latticeName) const
{
