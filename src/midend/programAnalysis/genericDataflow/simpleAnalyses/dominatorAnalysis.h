...
class DominatorLattice : public FiniteLattice
{
        ...
        bool copyFrom(const DominatorLattice* domLat, string indent="");
        ...
        // \pp \todo remove already default implemented by the Lattice class
        Lattice* project(SgExpression* expr) const;
