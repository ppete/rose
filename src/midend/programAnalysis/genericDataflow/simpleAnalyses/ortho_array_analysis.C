...
bool OrthoIndexVector_Impl::mayEqual(IndexVectorPtr other, const Part& p) const
{
...
bool OrthoIndexVector_Impl::mustEqual(IndexVectorPtr other, const Part& p) const
{
  //Dbg::dbg << "OrthoIndexVector_Impl::mayEqual()"<<endl;
