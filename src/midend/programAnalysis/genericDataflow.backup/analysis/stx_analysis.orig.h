 ...
 ******************************************/
  ...
  class IndexVector_Impl : public IndexVector
  {
    public:
      ...
      bool mayEqual(const IndexVector & other, const Part& p) const ;
      bool mustEqual(const IndexVector & other, const Part& p) const ;
  };
...
class ExprObj;
  ...
  { 
    public:
      ...
      bool mayEqual(MemLocObjectPtr o2, PartPtr p) const; 
      bool mustEqual(MemLocObjectPtr o2, PartPtr p) const; 
  ...
  { 
    public:
      ...
      bool mayEqual(NamedObjPtr o2, PartPtr p) const; 
      bool mustEqual(NamedObjPtr o2, PartPtr p) const; 
  ...
  {  // One object for each type
    public: 
      ...
      bool mayEqual(AliasedObjPtr o2, PartPtr p) const;
      bool mustEqual(AliasedObjPtr o2, PartPtr p) const;
  ...
  class LabeledAggregateNamedObj: public LabeledAggregate_Impl, public NamedObj
  {
    public:
      ...
      void init(SgSymbol* s, SgType* t, MemLocObjectPtr p, IndexVector* iv);
      std::set<SgType*> getType();
