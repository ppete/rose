...
class pCFG_contProcMatchAnalysis : public virtual pCFG_FWDataflow
{
        ...
        ConstrGraph*           genLattice(const Function& func, const pCFGNode& n, const NodeState& state);
        std::vector<NodeFact*> genFacts(const Function& func, const pCFGNode& n, const NodeState& state);
