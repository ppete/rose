...
template <class BasePredicate>
static inline
BasePredicate positive_clone_aux(const SgExpression& exp)
{
  return positive_clone(exp);
}

template <class BasePredicate>
static inline
BasePredicate negative_clone_aux(const SgExpression& exp)
{
  return negative_clone(exp);
}
                                    ...
                                    )
{
  ...
  constrain_twinedge(res, cp, lhs_guard, rhs_guard, positive_clone_aux<BasePredicate>, eckTrue);
  constrain_twinedge(res, cp, lhs_guard, rhs_guard, negative_clone_aux<BasePredicate>, eckFalse);
}
